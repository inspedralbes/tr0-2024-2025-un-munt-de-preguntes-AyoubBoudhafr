...
(1, 'Quina és la velocitat màxima permesa en una autopista en condicions normals?', '../web/img/autopista.jpg', 3, '80 km/h', '100 km/h', '120 km/h', '140 km/h'),
...
(7, 'Quina és la distància mínima que has de mantenir amb el vehicle que vas davant en carreteres secundàries?', '../web/img/distancia.jpg', 3, '1 metre', '2 metres', '4 metres', '5 metres'),
...
(10, 'Què has de fer si arribes a una rotonda amb senyal de cediu el pas?', '../web/img/rotonda.jpg', 1, 'Cedir el pas als vehicles que circulen per la rotonda', 'Entrar sense aturar-se', 'Aturar-se completament abans de continuar', 'Canviar de direcció sense mirar'),
...
(14, 'Què indica un senyal triangular amb fons blanc i vora vermella?', '../web/img/ceda.jpg', 1, 'Advertència de perill', 'Obligació de detenció', 'Restricció de velocitat', 'Prohibició d\'entrada'),
(15, 'Quan està permès estacionar davant d\'una entrada de garatge?', '../web/img/estacionar.jpg', 1, 'Mai', 'Només si hi ha senyalització que ho permet', 'Quan el garatge no està en ús', 'Durant la nit'),
(16, 'Què has de fer si et trobes amb una cruïlla sense senyals i un vehicle s\'aproxima des de la dreta?', '../web/img/derecha.jpg', 1, 'Cedir el pas', 'Continuar sense parar', 'Accelerar per passar primer', 'Aturar-te i esperar'),
(17, 'Què has de fer quan un vehicle d\'emergència amb llums i sirena et supera?', '../web/img/ambulancia.jpg', 1, 'Mantenir-te a la dreta i reduir la velocitat', 'Accelerar per no bloquejar el pas', 'Aturar-te al mig de la carretera', 'Seguir el vehicle d\'emergència'),
...
(19, 'Quin és l\'ús correcte dels llums de carretera en condicions de nit amb visibilitat clara?', '../web/img/carretera_noche.jpg', 1, 'Utilitzar els llums d\'altes', 'Utilitzar els llums de creuer', 'Utilitzar els llums de posició', 'Apagar els llums'),
(20, 'Com ha de ser la separació entre els vehicles en condicions de pluja intensa?', '../web/img/lluvia.jpg', 1, 'Més gran de l\'habitual', 'Menys gran de l\'habitual', 'Igual que en condicions normals', 'No cal preocupar-se per la separació');
