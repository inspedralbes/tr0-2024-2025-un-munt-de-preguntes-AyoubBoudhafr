...
if (isset($data['pregunta']) && isset($data['opciones']) && isset($data['respuesta_correcta'])) {
    ...
    if (count($opciones) === 4) {
        ...
        $sql = "INSERT INTO preguntes (pregunta, resposta_correcta, pregunta_1, pregunta_2, pregunta_3, pregunta_4) 
                VALUES ('$pregunta', '$respuesta_correcta', '$opcion1', '$opcion2', '$opcion3', '$opcion4')";
        ...
        echo json_encode(["success" => false, "message" => "Debes proporcionar exactamente 4 opciones."]);
    }
} else {
